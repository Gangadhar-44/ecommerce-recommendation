    ...
    products_data = [
        {
            ...
            'stock_quantity': 50,
            'image_url': '/static/recommendations/images/8_iPhone_vs_Samsung_The_ultimate_head.png'
        },
        {
            ...
            'stock_quantity': 45,
            'image_url': '/static/recommendations/images/2_3_919_Iphone_Samsung_Phones_Royalty.png'
        },
        {
            'name': 'MacBook Pro 16"',
            ...
            'stock_quantity': 30,
            'image_url': '/static/recommendations/images/3_Browse_thousands_of_E_Commerce_Laptop.png'
        },
        {
            'name': 'Dell XPS 15',
            ...
            'stock_quantity': 25,
            'image_url': '/static/recommendations/images/6_How_to_bring_the_same_B2C_customer.png'
        },
        {
            ...
            'stock_quantity': 60,
            'image_url': '/static/recommendations/images/1_Audio_Technica_ATH_S300BT_Wireless.png'
        },
        {
        ...
        },
        {
            ...
            'stock_quantity': 15,
            'image_url': '/static/recommendations/images/3_The_9_Best_mirrorless_cameras_in.png'
        },
        {
            'name': 'Nikon Z8',
            ...
            'stock_quantity': 20,
            'image_url': '/static/recommendations/images/7_Mirrorless_Camera_High_Quality_Dslr.png'
        },
        {
            'name': 'PlayStation 5',
            ...
            'stock_quantity': 35,
            'image_url': '/static/recommendations/images/4_Playstation_or_Xbox_Which_game_console.png'
        },
        {
            'name': 'Xbox Series X',
            ...
            'stock_quantity': 30,
            'image_url': '/static/recommendations/images/5_New_Xbox_Xbox_One_X_Playstation_PlayStation.png'
        },
        {
            'name': 'iPad Pro 12.9"',
            ...
            'stock_quantity': 40,
            'image_url': '/static/recommendations/images/6_Buy_iPad_Apple_IN_.png'
        },
        {
            'name': 'iPad Air',
            ...
            'stock_quantity': 55,
            'image_url': '/static/recommendations/images/10_Apple_iPad_Apple_.png'
        },
        {
            ...
            'stock_quantity': 25,
            'image_url': '/static/recommendations/images/9_The_3_Best_Fitness_Trackers_of_2026.png'
        },
        {
        ...
        },
        {
            ...
            'stock_quantity': 80,
            'image_url': '/static/recommendations/images/4_Dots_Background_Blue_Shoes_Photo.png'
        },
        {
            ...
            'stock_quantity': 70,
            'image_url': '/static/recommendations/images/1_Men_s_Leather_Shoes_Fashion_New_Arrival.png'
        },
        {
            ...
            'stock_quantity': 10,
            'image_url': '/static/recommendations/images/5_Zoovu_for_Home_Appliances_Ecommerce.png'
        },
        {
